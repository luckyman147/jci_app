...
String getAllPresidents(String start, String limit) =>
    "$SuperAdminUrl/getAllPresidents?start=$start&limit=$limit";
...
class Urls {
  ...
  static String ReplyUrl(ReplyComment ReplyActivityComment, String? user) {
    final images = ReplyActivityComment.user!.Images.isNotEmpty
        ? ReplyActivityComment.user!.Images[0]
        : null;
  ...
  static String OnCommentCreatedUrl(
          ActivityCommentModel comment, String? user, images) =>
      '${Urls.mainurl}/onCommentCreated?commentId=${comment.Commentid}&activityId=${comment.activityId}&content=${comment.content}&FirstName=${comment.user!.firstName}&LastName=${comment.user!.firstName}&memberId=$user&image=$images';
  @override
  ...
  static String AddNotes(String activityId) =>
      "$BaseUrl/Activity/notes/$activityId";
  static String SendReminderUrl(String activityId) =>
      "$BaseUrl/mails/SendReminder/$activityId";
  static String Addguest(String activityId) => "$guestUrl$activityId";
  static String deleteguest(String activityId, String guestId) =>
      "$guestUrl$activityId/$guestId";
  static String getAllParticipants(String activityId) =>
      "$BaseUrl/Activity/members/$activityId";
  static String CheckAbsence = "$BaseUrl/Activity/members";
  static String mailVerify = "$BaseUrl/mails/VerifyEmails";
  static String mailIcativityReporturl(String id) =>
      "$BaseUrl/mails/reportInactivity/$id";
  static String mailMembershipReporturl(String id) =>
      "$BaseUrl/mails/reportmembership/$id";
  ...
  static String InviteMemberUrl(String teamId, String memberid) =>
      "$TeamUrl$teamId/AddMember/$memberid";
  static String JoinTeam(
    String teamId,
  ) =>
      "$TeamUrl$teamId/JoinTeam";

  static String AddGuestToActivity(String activityId, String guestId) =>
      "$BaseUrl/Activity/guests/$activityId/$guestId";

  static String DeleteNotes(String act, String noteId) =>
      "$BaseUrl/Activity/notes/$act/$noteId";

  static String GetNotes(String activityId, String start, String limit) =>
      "$BaseUrl/Activity/notes/$activityId?start=$start&limit=$limit";

  static String UpdateNotes(String id) => "$BaseUrl/Activity/notes/$id";

  static String ChangeGuestToMember(String guestId) =>
      "$BaseUrl/admin/guest/ChangeToMember/$guestId";

  static String deleteMemberUrl(String id) => "$SuperAdminUrl/member/$id";

  static String downloadUrl(String activityId) =>
      "$BaseUrl/Activity/download/$activityId";
}
