...
class PermissionsModel extends Permission{
  ...
  factory PermissionsModel.fromMapEntry(MapEntry<String, dynamic> entry) {
    return PermissionsModel(type: entry.key.toPermissionType(), isGranted: entry.value);
  }
  // from entity
  ...
  // Convert to Map
  Map<String, bool> toMap() => {type.name: isGranted};
