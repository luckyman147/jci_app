...
class PVListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      onPressed: () {
                          final pvdto=PvParamDto(PVId: pv.id, pvParam: pv, ActivityId:  context.read<AcivityFBloc>().state.activityById!.id);
  ...
  Widget AddPVWidget(MediaQueryData mediaQuery,BuildContext context) {
    return Padding(
      ...
      final pvdto=PvParamDto(PVId: file.id, pvParam: file, ActivityId:  context.read<AcivityFBloc>().state.activityById!.id);
