                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: ClipRRect(
                                ...
                                child: CachedNetworkImageWidget(item: widget.Activities[index].CoverImages[0],height: mediaQuery.size.height / 6,
                                  width: 130.w,)),
                          ) :
                          InkWell(
                            highlightColor: Colors.transparent,
  ...
  builder: (context, state) {
    return Padding(
                              ...
                              children: [
                               ...
                               // Text("${"Start At".tr(context)} ${DateFormat('h:mm').format(widget.Activities[index].ActivityBeginDate)}",style: PoppinsRegular(mediaQuery.devicePixelRatio*5, isBefore?Colors.red:isBetween?Colors.green:textColorBlack),),
                                SizedBox(
                                    ...
                                    child: Text(widget.Activities[index].name.toUpperCase(),
                                ...
                                SizedBox(
                                  ...
                                  child:Text(
                                    ...
                                    style: PoppinsSemiBold(mediaQuery.devicePixelRatio*6, isBefore?Colors.red:isBetween?Colors.green:textColorBlack, TextDecoration.none),
                                  ),
                    ...
                    return Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        button(Activities: widget.Activities, mediaQuery: mediaQuery, index: index, act: widget.act, context: context),
                                        Pinnedbutton(onTap: (Activity ) {
                                          //context.read<AcivityFBloc>().add(AddPinnedEvent(act: Activity));
                                        }, isPinned: false, activity: widget.Activities[index],)
            ...
            future: ActivityAction.checkifMemberExist(state.activitiesSearch[index].Participants  ), // Your asynchronous function that returns a Future
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting|| state.activityfetchState==ActivityFetchState.LoadingButton) {
                  ...
                  return ShimmerButton(width: mediaQuery.size.width / 2.5, height: mediaQuery.size.height / 20,);
...
class ActivityOfMonthListWidget extends StatelessWidget {
  ...
  builder: (context, state) {
    ...
    ButtonComponent(Activities: Activities, index: index, top:  mediaQuery.size.height /3.1, left: mediaQuery.size.width/14 , mediaQuery: mediaQuery, act: act)
...
ClipRRect images(mediaQuery,List<Activity> activity,int index,double height,double width)=>
    ...
    ClipRRect(
        ...
        child: Container(
            ...
            width: width,
            color: Colors.grey,
            child: CachedNetworkImageWidget(item:activity[index].CoverImages[0] , height: height,width: height,))):
    ClipRRect(
      borderRadius: ActivityRaduis,
      child: Container(
        height: height,
