...
Future<void> initActivities() async {
  sl.registerFactory(() => ActivityCommentBloc(sl(),sl(),sl (),sl(),sl(),sl(),sl(),sl(),sl(),sl(),sl(),sl()));
  sl.registerFactory(() => PollBloc(sl(),sl(),sl(),sl(),sl(),sl(),sl()));
...
sl(),sl(),
  ...
  sl.registerFactory(() => ParticpantsBloc( UpdateAbsenceUseCases: sl(), getAllParticipantsUseCases: sl(), sendReminderUseCases: sl(), getParticipantsOfActivityUseCases: sl(), updateMembersAttendanceUseCases: sl(),



  ));
  sl.registerFactory(() => GuestsBloc(sl(),sl(),sl (),sl(),sl(),sl (),sl(),sl()));
  ...
  sl.registerFactory(() => AddDeleteUpdateBloc( checkPermissionsUseCase: sl(), updateActivityUseCases: sl(), createActivityUseCase: sl(), deleteActivityUseCases: sl()));
  sl.registerFactory(() => FormzBloc());

  sl.registerFactory(() => VisibleBloc());
  sl.registerFactory(() => CategoryBloc(sl(),sl(), sl(),sl(),sl(), sl(),sl()));
...
///datasources
  ...
  sl.registerLazySingleton<TrainingRemoteDataSource>(
          () => TrainingRemoteDataSourceImpl(sl(),sl(),sl(),client: sl()));
  sl.registerLazySingleton<EventRemoteDataSource>(
          () => EventRemoteDataSourceImpl(sl(),firabaseFireStore: sl(),logger: sl())

  );
  sl.registerLazySingleton<MeetingRemoteDataSource>(
          () =>
          MeetingRemoteDataSourceImpl(sl(),firabaseFireStore: sl()
...
//use cases
  ...
  sl.registerLazySingleton(() => CheckPermissionsUseCases(activitiesRepo: sl()));
//poll
...
///PV
  ...
  sl.registerLazySingleton(() => CheckAbsenceUseCases( participantsRepository: sl()));
  sl.registerLazySingleton(() => GetAllParticipantsUseCases(participantsRepository:  sl()));
  sl.registerLazySingleton(() => GetActivityByNameUseCases(activitiesRepo:  sl()));
  sl.registerLazySingleton(() => ChangeGuestToMemberUseCases(guestsRepository:   sl()));
  sl.registerLazySingleton(() => AddGuestToActivityUseCases( guestsRepository: sl()));
  ...
  sl.registerLazySingleton(() => GetParticipantsOfActivityUseCases(participantsRepository:   sl()));
  sl.registerLazySingleton(() => UpdateMembersAttendanceUseCases(participantsRepository:   sl()));



  // Repositories
   sl.registerLazySingleton<ActivitiesRepo>(() => ActivityRepoImpl(sl ( ),sl(),sl(),sl(),

        meetingLocalDataSource: sl(),
        eventLocalDataSource: sl(), meetingRemoteDataSource: sl(), trainingRemoteDataSource: sl(), eventRemoteDataSource: sl(), trainingLocalDataSource: sl(), Unithandler: sl()));
  sl.registerLazySingleton<GuestsRepository>(() => GuestRepoImpl(guestRemoteDataSources: sl(), unitHandler: sl(), actiguestHandler: sl(), actiguestsHandler: sl(), guestsHandler: sl()
  ));



  sl.registerLazySingleton<ParticipantsRepository>(() => ParticipantsRepoImpl(participantsRemoteDataSource: sl (), handler: sl(), partHandler: sl(), DetailsHandler: sl()
  ));
  sl.registerLazySingleton<PVrepo>(() => PvRepoImpl(
    remoteDataSource: sl(),
    localDataSources: sl(),
    unitHandler: sl(), listPVHandler: sl(),

  ));
  sl.registerLazySingleton<ActivityCommentRepo>(() => ActivityCommentRepoImpl(commentLocalDataSource: sl(), commentRemoteDataSource: sl(), unitHandler: sl(), commentHandler: sl()));
  sl.registerLazySingleton<PollRepository>(() => PollRepoImpl(sl(),pollRemoteDataSource: sl(), handler: sl(),));


  sl.registerLazySingleton<CategoryRepo>(() => CategoryRepoImpl(sl(),sl(),sl(),categoryRemoteDataSource: sl(),categoryLocalDataSource: sl()
  ));
  ...
  sl.registerFactory(() => Handler<List<ParticipantDetailsParam>>(sl(),networkInfo: sl()));
  sl.registerFactory(() => Handler<List<PV>>(sl(),networkInfo: sl()));

  sl.registerFactory(() => Handler<List<ActivityComment>>(sl(),networkInfo: sl()));
  sl.registerFactory(() => Handler<List<Poll>>(sl(),networkInfo: sl()));
  sl.registerFactory(() => Handler<List<Guest>>(sl(),networkInfo: sl()));
  sl.registerFactory(() => Handler<List<ActivityGuest>>(sl(),networkInfo: sl()));
