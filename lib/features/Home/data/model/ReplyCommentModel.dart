...
class ReplyCommentModel extends ReplyComment{
  ReplyCommentModel({required super.Commentid, required super.activityId, required super.user, required super.content, required super.Replyid, required super.createdAt});
