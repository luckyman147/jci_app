...
import '../../../../../Home/presentation/widgets/components/stuff/Compoenents.dart';
...
class TeamComponent{
    ...
    return Row(
      ...
      children: [
        ...
        StatusContainer((){
          ...
          context.read<GetTeamsBloc>().add(GetTeams(isPrivate: false,null, state.isUpdated));
        ...
        StatusContainer((){
          ...
          // Dispatch event to initialize GetTeamsBloc and fetch teams with updated privacy
          context.read<GetTeamsBloc>().add(initStatus());
          context.read<GetTeamsBloc>().add(const GetTeams(isPrivate: true,null, true));
 ...
 static  ElevatedButton StatusContainer(Function() onPressed, String text,bool isActive,Privacy privacy) {
    return ElevatedButton(
      ...
      onPressed: onPressed, child: AutoSizeText(text,style:PoppinsRegular(16,
        isActive?textColorWhite:textColorBlack),),);
  }
    ...
    return Row(
      children: [
        ...
        iconButton(context,Icons.cancel, (){
          ...
          context.read<GetTeamsBloc>().add(GetTeams(null,true,isPrivate: state.privacy==Privacy.Private));

        }),
        AddTeamButton(context)
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextField(
              ...
              onChanged: (value) {
                TeamUtils.searchFunction(value, context,state.privacy==Privacy.Private);
