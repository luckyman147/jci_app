...
class CreatePresidentUseCases extends UseCase<Unit,President >{
  final PresidentsRepo repo;

  CreatePresidentUseCases({required this.repo});
  @override
  Future<Either<Failure, Unit>> call(President params) {
...
class GetPresidentsUseCases extends UseCase<List<President>,NoParams >{
  final PresidentsRepo repo;

  GetPresidentsUseCases({required this.repo});
  @override
  Future<Either<Failure, List<President>>> call(NoParams params) {
    return repo.getPresidents();
  }
}
class UpdateImagePresidentUseCases extends UseCase<Unit,President >{
  final PresidentsRepo repo;
...
class UpdatePresidentUseCases extends UseCase<Unit,President >{
  final PresidentsRepo repo;
