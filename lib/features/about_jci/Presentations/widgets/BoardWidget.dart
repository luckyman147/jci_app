...
class _BoardYearPostsWidgetState extends State<BoardYearPostsWidget> {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      buildGridView(
                          postList,
                          priorityIndex + 1,
                          state.Listlength.isNotEmpty
                              ? state.Listlength[priorityIndex]
                              : 0),
                    ],
                  );
                },
  ...
  Container pho(Post post, BuildContext context) {
    return (post.assignTo.isEmpty) && post.assignTo[0].Images == null ||
            post.assignTo[0].Images.isEmpty
        ? Container(
            height: 110,
            width: 110,
            decoration: BoxDecoration(
        ...
        : Container(
            ...
            child: AboutMemberComponent.phot(
                post.assignTo[0].Images[0]["url"], context, 110),
          );
  }
}
