...
import '../member/MemberImpl.dart';

class BestMembersComponent{
  static  Widget MembersRanksBody(BuildContext context, List<User> members) {
    return Column(
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              final memberUser = members[index] ;
              final member=memberUser as Member;
...
visualDensity: VisualDensity.comfortable,
                      ...
                      title:Row(
                        ...
                        children: [
                          MemberImageWidget(item: member,height:  30,width:  18,bools: true ,size: 100),
                          Row(
  ...
  static Widget BestMembersWidget(List<User> members, BuildContext context) {
  ...
  static Container ColumBestMembers(User members,Color color,String index,double siez,BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("${(members as Member) .points} Pts", style: PoppinsSemiBold(16, PrimaryColor, TextDecoration.none)),
          ],
        ),
      ),
    );
  ...
  static SizedBox ImageRank(User members,Color color,String index,double size) {
    return SizedBox(
      height: 80,
      child: Stack(
        children: [
          ProfileImageWidget(item: members,height:  size),
          Positioned(
            top: 0,
            right: 0,
            child: Container(
  ...
  BoxShadow(
              ...
              child: Padding(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    ProfileImageWidget(item: member,height:  90),
                    Column(
