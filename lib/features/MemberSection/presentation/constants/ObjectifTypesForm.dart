...
static final ModificationGroup=ObjectifType(
    actionType: [
      ...
      ActionDetailsType(actionType: ObjectifActionType.Create,
          actionDetails: ActionDetails(runtype: "int",
              features: [FeaturesType.Events,FeaturesType.Meetings,FeaturesType.Trainings,FeaturesType.teams,FeaturesType.Tasks,
                FeaturesType.Subtasks,FeaturesType.Projects,FeaturesType.Strategies,
      ...
      ActionDetailsType(actionType: ObjectifActionType.Update,
          actionDetails: ActionDetails(runtype: "int",
              features: [FeaturesType.Events,FeaturesType.Meetings,FeaturesType.Trainings,FeaturesType.teams,FeaturesType.Subtasks,FeaturesType.Strategies,FeaturesType.Projects
                ,FeaturesType.Tasks,

                FeaturesType.Activities,FeaturesType.Votes,FeaturesType.Objectif],
              privacy: PrivacyType.values.toList(),
              cible: [CibleType.President, CibleType.VPs],
              difficulty: ObjectifDifficulty.values.toList())),
      ActionDetailsType(actionType: ObjectifActionType.Delete,
          actionDetails: ActionDetails(runtype: "int",
              features: [FeaturesType.Events,FeaturesType.Meetings,FeaturesType.Trainings,FeaturesType.teams,FeaturesType.Tasks,FeaturesType.Subtasks,
                FeaturesType.Activities,FeaturesType.Votes,
                FeaturesType.Projects,FeaturesType.Strategies,
                FeaturesType.Objectif,FeaturesType.Pv],
              privacy: PrivacyType.values.toList(),
              cible: [CibleType.President, CibleType.VPs],
              difficulty: ObjectifDifficulty.values.toList())),
    ],
