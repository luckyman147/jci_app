...
import '../widgets/MemberFeatures/BestMembersWidget.dart';
...
static isMode(SettingsBools state) {
  ...
  static Widget MembersAdmin(ChangeSboolsState state,BuildContext context) {
    ...
    return Form(
      ...
      child: Column(
             ...
             buildPasswordTextField(controller, state.isObscur, () => context. read<ChangeSboolsCubit>().changeObscur(!state.isObscur), (p0) {
               ...
               ButtonsMemberComponents.SaveChangesButton(()async{
